...
namespace Mocassin.Model.Translator.DbBuilder
{
    ...
    public class StructureDbModelBuilder : DbModelBuilder, IStructureDbModelBuilder
    {
        ...
        /// <inheritdoc />
        public StructureModel BuildModel(IKineticSimulationModel simulationModel)
        {
            ...
            structureModel.NumOfProbabilityTrackers = GetNumberOfProbabilityTrackers(simulationModel);
        ...
        /// <inheritdoc />
        public StructureModel BuildModel(IMetropolisSimulationModel simulationModel)
        {
            if (!ModelContext.SimulationModelContext.MetropolisSimulationModels.Any(x => ReferenceEquals(x, simulationModel)))
                throw new InvalidOperationException("Connected model context does not contain the passed simulation model");
        ...
        /// <summary>
        ///     Get the number of static trackers per cell that the passed kinetic simulation model requires
        /// </summary>
        /// <param name="simulationModel"></param>
        /// <returns></returns>
        public int GetNumberOfTrackersPerCell(IKineticSimulationModel simulationModel)
        {
            return simulationModel.KineticTrackingModel.StaticTrackerCount;
        }

        /// <summary>
        ///     Get the number of global trackers that the passed kinetic simulation model requires
        /// </summary>
        /// <param name="simulationModel"></param>
        /// <returns></returns>
        public int GetNumberOfGlobalTrackers(IKineticSimulationModel simulationModel)
        {
            return simulationModel.KineticTrackingModel.GlobalTrackerCount;
        }

        /// <summary>
        ///     Get the number of probability trackers that the passed kinetic simulation requires
        /// </summary>
        /// <param name="simulationModel"></param>
        /// <returns></returns>
        public int GetNumberOfProbabilityTrackers(IKineticSimulationModel simulationModel)
        {
            return simulationModel.KineticTrackingModel.ProbabilityTrackerCount;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public InteractionRange GetInteractionRange()
        {
            ...
            return new InteractionRange(cStructure);
        }
        ...
        /// <returns></returns>
        public ByteBuffer64 GetParticleIdBuffer(IParticleSet particleSet)
        {
            ...
            return new ByteBuffer64(cStruct);
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected StructureModel CreateNewModel()
        {
        ...
        /// </summary>
        /// <param name="structureModelel"></param>
        protected void LinkModel(StructureModel structureModel)
        {
            foreach (var entity in structureModel.EnvironmentDefinitions)
            {
                entity.StructureModel = structureModel;
            }
        }
    }
}