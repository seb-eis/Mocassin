...
namespace Mocassin.Model.Translator.DbBuilder
{
    ...
    public class EnergyDbModelBuilder : DbModelBuilder, IEnergyDbModelBuilder
    {
        ...
        /// <inheritdoc />
        public EnergyModel BuildModel(IKineticSimulationModel simulationModel)
        {
        ...
        /// <inheritdoc />
        public EnergyModel BuildModel(IMetropolisSimulationModel simulationModel)
        {
            var energyModel = CreateNewModel();
            LinkModel(energyModel);
            return energyModel;
        ...
        /// <param name="groupModel"></param>
        /// <returns></returns>
        public ByteBuffer64 GetParticleToEnergyTableMapping(IGroupEnergyModel groupModel)
        {
            ...
            return new ByteBuffer64(cBuffer);
        }
        ...
        public void LinkModel(EnergyModel energyModel)
        {
            foreach (var entity in energyModel.PairEnergyTables)
            {
                entity.EnergyModel = energyModel;
            }

            foreach (var entity in energyModel.ClusterEnergyTables)
            {
                entity.EnergyModel = energyModel;
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public EnergyModel CreateNewModel()
        {
