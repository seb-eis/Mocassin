...
{
    /// <summary>
    ///     Describes an energy hyper surface data point from a large collection average over a set of simulations with
    ///     attached meta data
    /// </summary>
    public class MmcfeEnergyDataPoint
    {
        ...
        public static int[] ParseParticleCounts(string str)
        {
            ...
            for (var i = 0; i < raw.Length; i++) result[i] = int.Parse(raw[i]);
