...
namespace Mocassin.Mathematics.Extensions
{
    ...
    public static class VectorExtensions
    {
        ...
        /// <summary>
        ///     Generic test wherever a <see cref="IFractional3D" /> lies within abounding cuboid defined by two
        ///     <see cref="IFractional3D" /> points
        /// </summary>
        ...
        /// <param name="comparer"></param>
        /// <returns>
        ///     -1 if any component is below the lower point, 0 if all are within bounds an +1 if any component is above the
        ///     upper point
        /// </returns>
