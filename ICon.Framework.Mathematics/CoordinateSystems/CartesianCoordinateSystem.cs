...
namespace Mocassin.Mathematics.Coordinates
{
    ...
    public class CartesianCoordinateSystem : AffineCoordinateSystem3D<Coordinates3D>
    {
        ...
        /// <inheritdoc />
        public override Coordinates3D ToReferenceSystem(in Coordinates3D original) => original;

        /// <inheritdoc />
        public override Coordinates3D ToSystem(in Coordinates3D original) => original;
    }
}