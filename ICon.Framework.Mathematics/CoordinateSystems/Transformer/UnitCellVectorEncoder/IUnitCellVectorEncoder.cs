...
namespace Mocassin.Mathematics.Coordinates
{
    ...
    public interface IUnitCellVectorEncoder
    {
        ...
        /// <summary>
        ///     Tries to encode the fractional vector that starts a specific fractional position into an absolute 4D vector
        ...
        /// <summary>
        ///     Tries to encode a spherical vector that starts at another arbitrarily defined vector position (Defined from unit
        ///     cell origin) into an absolute 4D vector (Returns false if not possible)
        /// </summary>
        /// <param name="origin"></param>
        /// <param name="vector"></param>
        /// <param name="encoded"></param>
        ...
        /// <summary>
        ///     Tries to encode a spherical vector that starts at another arbitrarily defined vector start (From unit cell origin)
        ///     into a relative 4D vector (Returns false if not possible)
        /// </summary>
        /// <param name="origin"></param>
        /// <param name="vector"></param>
        /// <param name="encoded"></param>
        ...
        /// <summary>
        ///     Tries to encode any 3D vector that starts at unit cell origin into an absolute 4D vector (Returns false if not
        ///     possible)
        /// </summary>
        /// <param name="vector"></param>
        /// <param name="encoded"></param>
        ...
        /// <summary>
        ///     Tries to encode any vector that starts at any other start vector into an absolute 4D vector (Returns false if not
        ///     possible)
        /// </summary>
        /// <param name="origin"></param>
        /// <param name="vector"></param>
        ...
        /// <summary>
        ///     Tries to encode any vector that is relative to any start vector into a 4D relative vector (Returns false if
        ///     possible)
        /// </summary>
        /// <param name="origin"></param>
        /// <param name="vector"></param>
        ...
        /// <param name="vector"></param>
        /// <returns></returns>
        VectorI3 GetTargetCellOffset(IFractional3D vector);
        ...
        /// <returns></returns>
        Fractional3D GetOriginCellTrimmedVector(IFractional3D vector, out VectorI3 offset);
