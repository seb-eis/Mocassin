...
namespace ICon.Mathematics.Coordinates
{
    ...
    public interface IVectorTransformer
    {
        ...
        /// <summary>
        /// Determines the coordinate type of a 3D vector by implemented interface and transform the coordinates into a basic cartesian vector
        /// </summary>
        ...
        /// <summary>
        /// Determines the coordinate type of a 3D vector by implemented interface and transform the coordinates into a basic fractional vector
        /// </summary>
        /// <param name="vector"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Determines the coordinate type of a 3D vector by implemented interface and transform the coordinates into a basic spherical vector
        /// </summary>
        /// <param name="vector"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Determines the coordinate type of a sequence of 3D vectors by implemented interface and transform the coordinates into a basic cartesian vector sequence
        /// </summary>
        ...
        /// <summary>
        /// Determines the coordinate type of a sequence of 3D vectors by implemented interface and transform the coordinates into a basic fractional vector sequence
        /// </summary>
        /// <param name="vectors"></param>
        /// <returns></returns>
