...
namespace Mocassin.Mathematics.Coordinates
{
    ...
    public class SphericalCoordinateSystem3D : AngularCoordinateSystem<Coordinates3D>
    {
        ...
        public override Coordinates3D ToReferenceSystem(in Coordinates3D original) =>
            new Coordinates3D(GetCoordinateX(original), GetCoordinateY(original), GetCoordinateZ(original));
        ...
        /// <returns></returns>
        public Cartesian3D ToReferenceSystem(in Spherical3D original) => new Cartesian3D(ToReferenceSystem(original.Coordinates));
        ...
        /// <param name="original"></param>
        /// <returns></returns>
        public Spherical3D ToSystem(in Cartesian3D original) => new Spherical3D(ToSystem(original.Coordinates));
        ...
        private static double CalculateRadius(in Coordinates3D original) =>
            Math.Sqrt(original.A * original.A + original.B * original.B + original.C * original.C);
        ...
        /// <returns></returns>
        private double CalculatePolarAngle(in Coordinates3D original, double radial) => PolarConstraint.ParseToPeriodicRange(Math.Acos(original.C / radial));
