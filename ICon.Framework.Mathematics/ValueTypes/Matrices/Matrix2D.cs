...
namespace Mocassin.Mathematics.ValueTypes
{
    ...
    public class Matrix2D : IEquatable<Matrix2D>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public bool IsSymmetric() => Values.IsSymmetric(Comparer);
        ...
        /// <param name="rhs"></param>
        /// <returns></returns>
        public static Matrix2D operator *(Matrix2D lhs, Matrix2D rhs) => new Matrix2D(lhs.Values.RightMatrixMultiplication(rhs.Values), lhs.Comparer);
    }
}