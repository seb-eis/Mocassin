...
{
    /// <summary>
    /// Geometric information for a mass point set. Contains multiple values to characterize the mecahnic properties of the mass points
    /// </summary>
    public class MassPointGeomertyInfo
    {
        /// <summary>
        /// The inertia tensor calcualted for the mass center as a matrix
        /// </summary>
        ...
        public MassPointGeomertyInfo(Matrix2D massCenterInertiaTensor, double sumOfMassTimesDistance, double totalMass, int totalMassPoints)
        {
            ...
            MassCenterInertiaTensor = massCenterInertiaTensor ?? throw new ArgumentNullException(nameof(massCenterInertiaTensor));
