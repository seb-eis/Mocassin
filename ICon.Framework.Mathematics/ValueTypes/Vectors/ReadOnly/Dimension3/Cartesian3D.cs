...
namespace ICon.Mathematics.ValueTypes
{
    ...
    public readonly struct Cartesian3D : ICartesian3D<Cartesian3D>
    {
        ...
        public Cartesian3D(Coordinates<Double, Double, Double> coordinates) : this()
        {
        ...
        /// <returns></returns>
        public Boolean IsLinearIndependetFrom(in Cartesian3D vecA, in Cartesian3D vecB, IEqualityComparer<Double> comparer)
        {
        ...
        /// <param name="comparer"></param>
        /// <returns></returns>
        public Boolean IsLinearIndependetFrom(in Cartesian3D vecA, IEqualityComparer<Double> comparer)
        {
