...
namespace Mocassin.Mathematics.ValueTypes
{
    ...
    public readonly struct Fractional3D : IFractional3D
    {
        ...
        /// <returns></returns>
        public static Fractional3D operator +(in Fractional3D lhs, in Fractional3D rhs) => new Fractional3D(lhs.A + rhs.A, lhs.B + rhs.B, lhs.C + rhs.C);
        ...
        /// <param name="rhs"></param>
        /// <returns></returns>
        public static Fractional3D operator *(in Fractional3D lhs, double rhs) => new Fractional3D(lhs.A * rhs, lhs.B * rhs, lhs.C * rhs);
        ...
        /// <param name="rhs"></param>
        /// <returns></returns>
        public static Fractional3D operator +(in Fractional3D lhs, IFractional3D rhs) => new Fractional3D(lhs.A + rhs.A, lhs.B + rhs.B, lhs.C + rhs.C);
        ...
        /// </summary>
        /// <returns></returns>
        public override string ToString() => $"Fractional3D ({A}, {B}, {C})";
        ...
        /// <param name="lhs"></param>
        /// <param name="rhs"></param>
        public static Fractional3D CalculateMiddle(in Fractional3D lhs, in Fractional3D rhs) => (lhs + rhs) * 0.5;
    }
}