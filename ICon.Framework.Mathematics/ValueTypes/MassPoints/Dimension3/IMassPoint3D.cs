namespace Mocassin.Mathematics.ValueTypes
{
    ...
    /// </summary>
    /// <typeparam name="T1"></typeparam>
    public interface ICartesianMassPoint3D<T1> : IMassPoint3D<T1>, ICartesian3D<T1> 
    ...
    /// </summary>
    /// <typeparam name="T1"></typeparam>
    public interface IFractionalMassPoint3D<T1> : IMassPoint3D<T1>, IFractional3D<T1> 
        where T1 : struct, IFractionalMassPoint3D<T1>
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="T1"></typeparam>
    public interface ISphericalMassPoint3D<T1> : IMassPoint3D<T1>, ISpherical3D<T1> 
        where T1 : struct, ISphericalMassPoint3D<T1>
    {
        /// <summary>
