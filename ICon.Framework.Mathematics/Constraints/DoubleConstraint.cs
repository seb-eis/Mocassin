...
namespace ICon.Mathematics.Constraints
{
    ...
    public class DoubleConstraint : ValueConstraint<Double>
    {
        ...
        public DoubleConstraint(Boolean minIncluded, Double minValue, Double maxValue, Boolean maxIncluded, DoubleComparer comparer) : base(minIncluded, minValue, maxValue, maxIncluded)
        {
            Comparer = comparer;
        }
