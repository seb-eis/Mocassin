...
namespace ICon.Mathematics.Permutation
{
    ...
    public class PermuterSlot<T1> where T1 : IComparable<T1>
    {
        ...
        public PermuterSlot(IEnumerable<T1> valueOptions, IComparer<T1> comparer = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Boolean NextWithPeriodicCheck()
        {
            Next();
        ...
        /// </summary>
        /// <returns></returns>
        public Boolean PreviousWithPeriodicCheck()
        {
            Previous();
