...
namespace Mocassin.UI.GUI.Controls.DxVisualizer.Extensions
{
    ...
    {
        /// <summary>
        ///     Attached <see cref="DependencyProperty" /> to disable MSAA during user interaction with a
        ///     <see cref="Viewport3DX" />
        /// </summary>
        public static readonly DependencyProperty DisableMsaaOnInteractionProperty =
            DependencyProperty.RegisterAttached("DisableMssaOnInteraction", typeof(bool), typeof(DxViewportExtensions), new PropertyMetadata(true));

        /// <summary>
        ///     Attached <see cref="DependencyProperty" /> to define if a user is interacting with a <see cref="Viewport3DX" />
        /// </summary>
        public static readonly DependencyProperty IsInteractingProperty =
            DependencyProperty.RegisterAttached("IsInteracting", typeof(bool), typeof(DxViewportExtensions), new PropertyMetadata(false));
