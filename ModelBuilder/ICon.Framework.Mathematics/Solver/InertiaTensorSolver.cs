...
namespace Mocassin.Mathematics.Solver
{
    ...
    public class InertiaTensorSolver
    {
        ...
        private static double Determinant(IReadOnlyList<double> diagonal, IReadOnlyList<double> outer) =>
            diagonal[0] * (diagonal[1] * diagonal[2] - outer[2] * outer[2])
        ...
        /// <param name="tensor"></param>
        /// <returns></returns>
        private static double Trace(double[,] tensor) => tensor[0, 0] + tensor[1, 1] + tensor[2, 2];
        ...
        /// <returns></returns>
        private static double Quad(double value) => value * value;
    }
}