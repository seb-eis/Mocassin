...
namespace Mocassin.Mathematics.Extensions
{
    ...
    public static class CartesianVectorExtensions
    {
        ...
        /// <returns></returns>
        public static double GetLength(this ICartesian3D vector) => Math.Sqrt(vector.X * vector.X + vector.Y * vector.Y + vector.Z * vector.Z);
        ...
        public static bool IsLinearIndependent(this ICartesian3D first, ICartesian3D second, IEqualityComparer<double> comparer) =>
            first.Coordinates.IsLinearIndependentFrom(second.Coordinates, comparer);
        ...
        /// <param name="vector"></param>
        /// <returns></returns>
        public static Cartesian3D GetNormalized(this Cartesian3D vector) => vector * (1.0 / vector.GetLength());
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static double GetScalarProduct(this Cartesian3D first, in Cartesian3D second) => first.X * second.X + first.Y * second.Y + first.Z * second.Z;
        ...
        public static Cartesian3D GetCrossProduct(this Cartesian3D first, in Cartesian3D second) =>
            new Cartesian3D(first.Coordinates.GetCrossProduct(second.Coordinates));
        ...
        public static double GetSpatProduct(this Cartesian3D first, in Cartesian3D second, in Cartesian3D third) =>
            first.GetScalarProduct(second.GetCrossProduct(third));
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static double GetProjectionLength(this Cartesian3D first, in Cartesian3D second) => first.GetScalarProduct(second.GetNormalized());
        ...
        public static Cartesian3D GetProjection(this Cartesian3D first, in Cartesian3D second) =>
            second * (first.GetScalarProduct(second) / second.GetLength());
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static Cartesian3D GetRejection(this Cartesian3D first, in Cartesian3D second) => first - first.GetProjection(second);
        ...
        public static Cartesian3D GetNormalVector(this Cartesian3D first, in Cartesian3D second) =>
            first - second.GetNormalized() * first.GetProjectionLength(second);
    }
}