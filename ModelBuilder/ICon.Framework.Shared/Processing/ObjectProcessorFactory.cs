...
namespace Mocassin.Framework.Processing
{
    ...
    public static class ObjectProcessorFactory
    {
        ...
        /// <returns></returns>
        public static ObjectProcessor<T1, TResult> Create<T1, TResult>(Func<T1, TResult> handler) => new ObjectProcessor<T1, TResult>(handler);
        ...
        /// <param name="handler"></param>
        /// <returns></returns>
        public static ObjectProcessor<T1, T2, TResult> Create<T1, T2, TResult>(Func<T1, T2, TResult> handler) => new ObjectProcessor<T1, T2, TResult>(handler);
