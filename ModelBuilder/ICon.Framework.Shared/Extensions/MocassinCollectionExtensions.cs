...
namespace Mocassin.Framework.Extensions
{
    ...
    public static class MocassinCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IEnumerable<T1> SelectRandomSubset<T1>(this ICollection<T1> collection, int count, System.Random random)
        {
        ...
        /// <returns></returns>
        public static IEnumerable<T2> SelectRandomSubset<T1, T2>(this ICollection<T1> collection, int count, System.Random random, Func<T1, T2> selector) =>
            collection.SelectRandomSubset(count, random).Select(selector);
        ...
        /// <param name="random"></param>
        /// <returns></returns>
        public static IEnumerable<int> SelectRandomSubsetIndices<T1>(this ICollection<T1> collection, int count, System.Random random)
        {
            if (count >= collection.Count)
            {
        ...
        /// <returns></returns>
        public static IDisposable SubscribeToContentChanges<T>(this IList<T> observer, ObservableCollection<T> observable)
        {
