...
namespace Mocassin.Framework.QuickTest
{
    public static class RadialSampleScript
    {
        ...
        {
            var mslPath = @"C:\Users\Sebastian\Documents\Promotion\MocassinTests\neuMeli.msl";
            ...
            var modelContext = evalSet.First().ModelContext;
            var evaluation = new CellSiteCoordinationEvaluation(evalSet, 10);
