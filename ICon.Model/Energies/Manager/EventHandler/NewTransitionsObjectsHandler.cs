...
{
    /// <summary>
    /// Event handler that manages the processing of object added events that the energy manager receives from the transition manager event port
    /// </summary>
    internal class NewTransitionObjectsHandler : NewObjectsEventHandler<ITransitionEventPort, EnergyModelData, EnergyEventManager>
    {
        /// <summary>
        ...
        public NewTransitionObjectsHandler(IProjectServices projectServices, DataAccessProvider<EnergyModelData> dataAccessorProvider, EnergyEventManager eventManager)
