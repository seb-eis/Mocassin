...
{
    /// <summary>
    /// Event handler that manages the processing of object reindexing events that the energy manager receives from the transition manager event port
    /// </summary>
    internal class ReindexedTransitionObjectsHandler : ReindexedObjectsEventHandler<ITransitionEventPort, EnergyModelData, EnergyEventManager>
    {
        /// <summary>
        ...
        public ReindexedTransitionObjectsHandler(IProjectServices projectServices, DataAccessProvider<EnergyModelData> dataAccessorProvider, EnergyEventManager eventManager)
