...
{
    /// <summary>
    /// Attribute that marks a property as indexed model data which supports reindexing operations and a specific model object interface
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    public class IndexedModelDataAttribute : Attribute
    {
        /// <summary>
        /// Flag that marks the indexed model data aus automatically generated and managed by the manager (No custom input support)
        /// </summary>
