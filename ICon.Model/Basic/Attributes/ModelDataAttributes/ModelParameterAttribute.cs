...
namespace ICon.Model.Basic
{
    ...
    class ModelParameterAttribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        /// Create new model parameter attribute with the specififed parameter interface type
        /// </summary>
        ...
        public ModelParameterAttribute(Type interfaceType)
        {
            ...
            {
                throw new ArgumentException("Specified interface type does not implement general model parameter interface", nameof(interfaceType));
            }
