...
{
    /// <summary>
    /// Abstract base class for event handlers that handle object list reindexings provided by the specfified event port
    /// </summary>
    /// <typeparam name="T1"></typeparam>
    internal abstract class ReindexedObjectsEventHandler<T1, T2, T3> : ModelEventHandler<T1, T2, T3>
        where T1 : IModelEventPort
        where T2 : ModelData
        where T3 : ModelEventManager
    {
        /// <summary>
        /// Create new object list reindexed event handler
        /// </summary>
        /// <param name="projectServices"></param>
        /// <param name="dataAccessorProvider"></param>
        /// <param name="eventManager"></param>
        public ReindexedObjectsEventHandler(IProjectServices projectServices, DataAccessProvider<T2> dataAccessorProvider, T3 eventManager)
