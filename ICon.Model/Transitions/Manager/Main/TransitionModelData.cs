...
namespace Mocassin.Model.Transitions
{
    ...
    public class TransitionModelData : ModelData<ITransitionDataPort>
    {
        ...
        /// </summary>
        [DataMember, IndexedModelData(typeof(IMetropolisRule), IsAutoManaged = true)]
        public List<MetropolisRule> MetropolisRules { get; set; }

        /// <summary>
        ///     The list of kinetic transition rules (Auto-managed by model)
        /// </summary>
        [DataMember, IndexedModelData(typeof(IKineticRule), IsAutoManaged = true)]
        public List<KineticRule> KineticRules { get; set; }

        /// <inheritdoc />
        public override ITransitionDataPort AsReadOnly() => new TransitionDataManager(this);
