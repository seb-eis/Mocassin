...
{
    /// <summary>
    ///     Event handler that manages the processing of object added events that the transition manager receives from the
    ...
    {
        /// <inheritdoc />
        public StructureObjectAddedEventHandler(IModelProject modelProject, DataAccessorSource<TransitionModelData> dataAccessorSource,
        ...
        /// <returns></returns>
        [EventHandlingMethod]
        protected IConflictReport HandleNewCellReferencePosition(IModelObjectEventArgs<ICellSite> eventArgs) => new ConflictReport();
    }
}