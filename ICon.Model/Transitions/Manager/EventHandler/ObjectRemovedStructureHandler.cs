...
namespace ICon.Model.Transitions.Handler
{
    ...
    internal class ObjectRemovedStructureHandler : ObjectRemovedEventHandler<IStructureEventPort, TransitionModelData, TransitionEventManager>
    {
        ...
        public ObjectRemovedStructureHandler(IProjectServices projectServices, DataAccessSource<TransitionModelData> dataAccessorSource, TransitionEventManager eventManager)
