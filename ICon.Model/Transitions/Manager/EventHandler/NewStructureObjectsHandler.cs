...
namespace Mocassin.Model.Transitions.Handler
{
    ...
    internal class NewStructureObjectsHandler : ObjectAddedEventHandler<IStructureEventPort, TransitionModelData, TransitionEventManager>
    {
        ...
        public NewStructureObjectsHandler(IModelProject modelProject, DataAccessSource<TransitionModelData> dataAccessorSource, TransitionEventManager eventManager)
