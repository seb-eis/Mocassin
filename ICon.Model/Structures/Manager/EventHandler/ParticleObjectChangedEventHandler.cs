...
namespace Mocassin.Model.Structures.Handler
{
    ...
    internal class ParticleObjectChangedEventHandler : ObjectChangedEventHandler<IParticleEventPort, StructureModelData, StructureEventManager>
    {
        ...
        /// <returns></returns>
        [EventHandlingMethod]
        protected IConflictReport HandleParticleChange(IModelObjectEventArgs<IParticle> eventArgs) => new ConflictReport();
        ...
        /// <returns></returns>
        [EventHandlingMethod]
        protected IConflictReport HandleParticleSetChange(IModelObjectEventArgs<IParticleSet> eventArgs) => new ConflictReport();
    }
}