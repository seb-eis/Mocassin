...
namespace ICon.Model.Structures.Handler
{
    ...
    internal class NewParticleObjectsHandler : ObjectAddedEventHandler<IParticleEventPort, StructureModelData, StructureEventManager>
    {
        ...
        public NewParticleObjectsHandler(IProjectServices projectServices, DataAccessSource<StructureModelData> dataAccessorSource, StructureEventManager eventManager)
