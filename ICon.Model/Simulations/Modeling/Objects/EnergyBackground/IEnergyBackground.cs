...
{
    /// <summary>
    ///     Represents a 5D simulation energy background that assigns each particle on each possible position an energetic
    ///     offset value
    /// </summary>
    public interface IEnergyBackground : IEnumerable<double>
    {
        /// <summary>
        ///     Generates the full 5D energy hyper surface by the set of existing particles and the lattice dimension as a 4D
        ///     vector
        /// </summary>
