...
{
    /// <summary>
    ///     Implementation of the simulation manager that handles the creation and packaging of simulation sets for simulation
    ///     encoding
    /// </summary>
    internal class SimulationManager : ModelManager<SimulationModelData, SimulationModelCache, SimulationDataManager, SimulationCacheManager,
        SimulationInputManager, SimulationQueryManager, SimulationEventManager, SimulationUpdateManager>, ISimulationManager
    {
        /// <summary>
        ...
        public SimulationManager(IModelProject modelProject, SimulationModelData data)
