...
namespace Mocassin.Model.ModelProject
{
    ...
    ///     the model process
    /// </summary>
    [DataContract, XmlRoot("MocassinNumericSettings")]
    public class MocassinNumericSettings
    {
        ...
        /// </summary>
        [DataMember, XmlAttribute("UlpCompare")]
        ...
        /// </summary>
        [DataMember, XmlAttribute("RangeCompare")]
        ...
        /// </summary>
        [DataMember, XmlAttribute("FactorCompare")]
