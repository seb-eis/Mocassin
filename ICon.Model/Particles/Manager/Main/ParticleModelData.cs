...
namespace Mocassin.Model.Particles
{
    ...
    public class ParticleModelData : ModelData<IParticleDataPort>
    {
        ...
        /// </summary>
        [DataMember(Name = "Particles"), IndexedModelData(typeof(IParticle))]
        public List<Particle> Particles { get; set; }

        /// <summary>
        ///     The list of currently known particle sets
        /// </summary>
        [DataMember(Name = "ParticleSets"), IndexedModelData(typeof(IParticleSet))]
        ...
        /// </summary>
        /// <returns></returns>
        public static ParticleModelData CreateNew() => CreateDefault<ParticleModelData>();

        /// <inheritdoc />
        public override IParticleDataPort AsReadOnly() => new ParticleDataManager(this);
