...
{
    /// <summary>
    /// Represents a read only data port for the particle manager that allows data access on the particle manager base data through interfaces
    /// </summary>
    public interface IParticleDataPort : IModelDataPort
    {
        ...
        /// <summary>
        /// Get a clean indexing information for the particle sets that is equivalent to the reindexing info after a deprecated data cleanup
        /// </summary>
        /// <returns></returns>
