...
{
    /// <summary>
    /// Pair code struct that defines a pair interaction between two particles. The first index is laways dfined to be lesser or equal to the second
    /// </summary>
    public readonly struct PairCode : IEquatable<PairCode>, IComparable<PairCode>
    {
        ...
        public PairCode(int index0, int index1) : this()
        {
        ...
        /// <summary>
        /// Checks for equality of the pair code
        /// </summary>
        ...
        {
            int first = Index0.CompareTo(other.Index0);
            if (first != 0)
            {
