...
namespace Mocassin.Framework.Extensions
{
    ...
    public static class MocassinStructExtensions
    {
        ...
        /// <returns></returns>
        public static int CountMatchesWithParameters<T1>(this T1 value, IEqualityComparer<T1> comparer, params T1[] testValues) where T1 : struct
        {
            if (comparer == null)
        ...
        /// <returns></returns>
        public static int CountMatchesWithParameters<T1>(this T1 value, IEqualityComparer<T1> comparer, IEnumerable<T1> values) where T1 : struct
        {
            if (comparer == null)
                throw new ArgumentNullException(nameof(comparer));
