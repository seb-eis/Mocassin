...
{
    /// <summary>
    /// Delegate creator class that use reflection to search for methods that fullfil specfific coditions and creates delegates for these methods
    /// </summary>
    public class DelegateCreator
    {
        ...
        /// <summary>
        /// Searches the provided instance for methods that match the predicate and binding flags and returns a sequence of delegates to these methods
        /// </summary>
        ...
        {
            var methods = FindMethods(instance.GetType(), predicate, bindingFlags);
        ...
        /// <summary>
        /// Searches the provided instance for methods that match the prediacte (both public and non public) and returns a sequence of delegates to these methods
        /// </summary>
        /// <param name="instance"></param>
        /// <param name="predicate"></param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        public IEnumerable<Type> MakeDelegateTypes(IEnumerable<MethodInfo> methodInfos)
        {
            return methodInfos.Select(methodInfo => GetGenericDelegateType(methodInfo));
        }
        ...
        /// <param name="prediacte"></param>
        /// <returns></returns>
        public IEnumerable<MethodInfo> FindInstanceMethods(Type objType, Predicate<MethodInfo> prediacte)
        {
            return FindMethods(objType, prediacte, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
        }
        ...
        /// <param name="bindingFlags"></param>
        /// <returns></returns>
        public IEnumerable<MethodInfo> FindMethods(Type objType, Predicate<MethodInfo> prediacte, BindingFlags bindingFlags)
        {
            return objType.GetMethods(bindingFlags).Where(info => prediacte(info));
        }
        ...
        /// <summary>
        /// Get the raw type of a function that has the specfified number of parameters
        /// </summary>
        /// <param name="paramCount"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates an array that contains the supported raw action types, each index affiliates to the number of delegate parameters
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates an array that contains the supported raw function types, each index affiliates to the number of delegate parameters
        /// </summary>
        /// <returns></returns>
