...
namespace Mocassin.Framework.Collections
{
    ...
    /// </summary>
    public static class SetListFactory
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static SetList<T1> CreateSetList<T1>(IComparer<T1> comparer) => new SetList<T1>(comparer);
        ...
        /// <param name="comparer"></param>
        /// <returns></returns>
        public static MultisetList<T1> CreateMultisetList<T1>(IComparer<T1> comparer) => new MultisetList<T1>(comparer);
