...
namespace Mocassin.Framework.Processing
{
    ...
    public class ObjectProcessor<T1, TResult> : IObjectProcessor<TResult>
    {
        ...
        /// <inheritdoc />
        public bool CanProcess(object obj, params object[] args) => args.Length == 0 && obj is T1;

        /// <inheritdoc />
        public TResult Process(object obj, params object[] args) => ProcessDelegate((T1) obj);
    }
    ...
    public class ObjectProcessor<T1, T2, TResult> : IObjectProcessor<TResult>
    {
        ...
        /// <inheritdoc />
        public TResult Process(object obj, params object[] args) => ProcessDelegate((T1) obj, (T2) args[0]);
    }
}