...
namespace Mocassin.Framework.Messaging
{
    ...
    public interface IPushMessageSystem
    {
        ...
        /// </summary>
        IObservable<ErrorMessage> ErrorMessageNotification { get; }

        /// <summary>
        ///     Observable for info message subscriptions
        /// </summary>
        IObservable<InfoMessage> InfoMessageNotification { get; }

        /// <summary>
        ///     Observable for warning message subscriptions
        /// </summary>
        IObservable<WarningMessage> WarningMessageNotification { get; }

        /// <summary>
        ///     Observable for subscriptions to all messages
        /// </summary>
        IObservable<PushMessage> AnyMessageNotification { get; }
