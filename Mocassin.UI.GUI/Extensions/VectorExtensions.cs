...
namespace Mocassin.UI.GUI.Extensions
{
    ...
    public static class VectorExtensions
    {
        ...
        /// <returns></returns>
        public static Point3D AsPoint3D(this Cartesian3D cartesian)
        {
            return new Point3D(cartesian.X, cartesian.Y, cartesian.Z);
        }
        ...
        /// <param name="cartesian"></param>
        /// <returns></returns>
        public static Vector3D AsVector3D(this Cartesian3D cartesian)
        {
