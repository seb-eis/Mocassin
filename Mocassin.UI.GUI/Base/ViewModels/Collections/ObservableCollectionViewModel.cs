...
namespace Mocassin.UI.GUI.Base.ViewModels.Collections
{
    ...
    public class ObservableCollectionViewModel<T> : ViewModelBase, IObservableCollectionViewModel<T>
    {
        ...
        /// <summary>
        ///     Get the first occurence of item <see cref="T" /> that matches the predicate or creates a new one if no match is
        ///     found. By default the new item is added to the collection
        /// </summary>
