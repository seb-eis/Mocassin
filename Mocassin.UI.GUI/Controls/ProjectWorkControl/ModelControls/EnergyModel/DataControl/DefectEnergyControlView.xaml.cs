...
{
    /// <summary>
    ///     Interaktionslogik für DefectEnergyControlView.xaml
    /// </summary>
    public partial class DefectEnergyControlView : UserControl
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public DefectEnergyControlView()
        {
        ...
        {
            RowHeaderDragHandler.RegisterDragStartPoint(DefectEnergiesDataGrid, e);
        }

        private void RowHeaderLogo_OnPreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            RowHeaderDragHandler.DeleteDragStartPoint(DefectEnergiesDataGrid, e);
        }

        private void RowHeaderLogo_OnPreviewMouseMove(object sender, MouseEventArgs e)
        {
            RowHeaderDragHandler.TryDoDragDrop(DefectEnergiesDataGrid, e);
        }
    }
}