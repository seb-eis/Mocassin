...
namespace Mocassin.UI.GUI.Controls.ProjectWorkControl.ModelControls.EnergyModel.DataControl
{
    ...
    public partial class GroupInteractionControlView : UserControl
    {
        ...
        {
            RowHeaderDragHandler.RegisterDragStartPoint(GroupInteractionDataGrid, e);
        }

        private void RowHeaderLogo_OnPreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            RowHeaderDragHandler.DeleteDragStartPoint(GroupInteractionDataGrid, e);
        }

        private void RowHeaderLogo_OnPreviewMouseMove(object sender, MouseEventArgs e)
        {
            RowHeaderDragHandler.TryDoDragDrop(GroupInteractionDataGrid, e);
        }
    }
}