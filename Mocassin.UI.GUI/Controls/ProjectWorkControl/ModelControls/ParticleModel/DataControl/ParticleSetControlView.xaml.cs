...
{
    /// <summary>
    ///     Interaktionslogik für ParticleSetControlView.xaml
    /// </summary>
    public partial class ParticleSetControlView : UserControl
    {
        /// <summary>
        ...
        {
            RowHeaderDragHandler.RegisterDragStartPoint(ParticleSetDataGrid, e);
        }

        private void RowHeaderLogo_OnPreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            RowHeaderDragHandler.DeleteDragStartPoint(ParticleSetDataGrid, e);
        }

        private void RowHeaderLogo_OnPreviewMouseMove(object sender, MouseEventArgs e)
        {
            RowHeaderDragHandler.TryDoDragDrop(ParticleSetDataGrid, e);
        }
    }
}