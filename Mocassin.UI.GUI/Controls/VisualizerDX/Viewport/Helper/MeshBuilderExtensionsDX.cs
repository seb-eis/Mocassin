...
{
    public static class MeshBuilderExtensionsDX
    {
        /// <summary>
        ...
        public static void AddTwoHeadedArrow(this MeshBuilder builder, in Vector3 point0, in Vector3 point1, double diameter, double headLength = 3, int thetaDiv = 18)
        {
