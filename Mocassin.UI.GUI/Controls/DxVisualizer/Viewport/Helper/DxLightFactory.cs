...
namespace Mocassin.UI.GUI.Controls.DxVisualizer.Viewport.Helper
{
    ...
    public static class DxLightFactory
    {
        ...
        /// </summary>
        public static GroupModel3D DefaultLightModel3D() => DefaultLightModel3D(Colors.White);
        ...
        public static AmbientLight3D DefaultAmbientLight3D(in Color color, double intensity = 1.0) =>
            new AmbientLight3D {Color = color.ChangeIntensity(intensity)};
        ...
        /// <returns></returns>
        /// <param name="intensity"></param>
        public static AmbientLight3D DefaultAmbientLight3D(double intensity = 1.0) => DefaultAmbientLight3D(Colors.White, intensity);
        ...
        /// <param name="z"></param>
        /// <returns></returns>
        public static DirectionalLight3D DirectionalLight3D(in Color color, double x, double y, double z) => DirectionalLight3D(color, new Vector3D(x, y, z));
        ...
        public static DirectionalLight3D DirectionalLight3D(in Color color, in Vector3D direction) =>
            new DirectionalLight3D {Color = color, Direction = direction};
    }
}