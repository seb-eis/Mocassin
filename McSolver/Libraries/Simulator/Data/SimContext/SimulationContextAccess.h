...
static inline JobDbModel_t* getDatabaseModel(SCONTEXT_PARAMETER)
{
...
static inline MocsimUuid_t* getCustomRoutineUuid(SCONTEXT_PARAMETER)
{
    return (MocsimUuid_t*) getCustomRoutineData(simContext)->Guid;
}
