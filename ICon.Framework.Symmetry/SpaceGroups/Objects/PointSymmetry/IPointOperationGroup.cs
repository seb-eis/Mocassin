...
namespace Mocassin.Symmetry.SpaceGroups
{
    ...
    public interface IPointOperationGroup
    {
        ...
        /// <summary>
        ///     Get all existing unique point sequences of the group that consider original order of participants (May contain entries where only the order of points is different)
        /// </summary>
        /// <returns></returns>
        IEnumerable<IEnumerable<Fractional3D>> GetAllUniqueSequencesWithPreservedPointOrder();

        /// <summary>
        ///     Get all existing unique point sequences of the group that do not consider original order of participants (Cannot contain entries where only the order of points is different)
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///     Get all existing unique sequence operations of the group that consider original order of participants (May contain entries where only the order of points is different)
        /// </summary>
        ...
        /// <summary>
        ///     Get all unique permutations (considering value and geometry) within the provided permutation provider using the provided equality comparer and single value selector function for hash value generation
        /// </summary>
