...
namespace Mocassin.Symmetry.SpaceGroups
{
    ...
    public readonly struct SymmetryOperationCore
    {
        ...
        /// <inheritdoc />
        public override string ToString() => $"{M11},{M12},{M13},{M14};{M21},{M22},{M23},{M24};{M31},{M32},{M33},{M34}";
        ...
        /// <returns></returns>
        public static Fractional3D operator *(in SymmetryOperationCore core, in Fractional3D vector) => core.Transform(vector);
        ...
        /// <returns></returns>
        public Fractional3D TrimTransform(in Fractional3D vector, double trimTolerance) => Transform(vector).TrimToUnitCell(trimTolerance);
        ...
        public Fractional3D TrimTransform(double orgA, double orgB, double orgC, double trimTolerance) =>
            Transform(orgA, orgB, orgC).TrimToUnitCell(trimTolerance);
        ...
        /// <returns></returns>
        public bool FlipsOrientation(double tolerance = 1.0e-10) => DeterminantTop3X3() < -Math.Abs(tolerance);
        ...
        public SymmetryOperationCore Offset(double a, double b, double c) =>
            new SymmetryOperationCore(M11, M12, M13, M14 + a, M21, M22, M23, M24 + b, M31, M32, M33, M34 + c);
        ...
        /// <returns></returns>
        public SymmetryOperationCore Offset(in Fractional3D offset) => Offset(offset.A, offset.B, offset.C);
    }
}