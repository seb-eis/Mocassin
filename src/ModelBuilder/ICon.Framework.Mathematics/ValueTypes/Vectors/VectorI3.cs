...
namespace Moccasin.Mathematics.ValueTypes
{
    ...
    public readonly struct VectorI3
    {
        ...
        /// <returns></returns>
        public static VectorI3 operator +(VectorI3 lhs, VectorI3 rhs) => new VectorI3(lhs.A + rhs.A, lhs.B + rhs.B, lhs.C + rhs.C);
        ...
        /// <param name="rhs"></param>
        /// <returns></returns>
        public static double operator *(VectorI3 lhs, VectorI3 rhs) => lhs.A * rhs.A + lhs.B * rhs.B + lhs.C * rhs.C;
        ...
        /// <returns></returns>
        public static VectorI3 operator *(VectorI3 lhs, int scalar) => new VectorI3(lhs.A * scalar, lhs.B * scalar, lhs.C * scalar);
        ...
        /// </summary>
        /// <returns></returns>
        public double GetLength() => Math.Sqrt(A * A + B * B + C * C);

        /// <summary>
        ///     Get the volume of a cuboid generated by this vector
        /// </summary>
        /// <returns></returns>
        public int GetCoordinateProduct() => A * B * C;
        ...
        /// <returns></returns>
        public bool Equals(in VectorI3 vector) => A == vector.A && B == vector.B && C == vector.C;
    }
}