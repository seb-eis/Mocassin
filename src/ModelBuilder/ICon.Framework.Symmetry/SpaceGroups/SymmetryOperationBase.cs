...
namespace Mocassin.Symmetry.SpaceGroups
{
    ...
    public abstract class SymmetryOperationBase : ISymmetryOperation
    {
        ...
        /// <inheritdoc />
        public Fractional3D TrimTransform(double orgA, double orgB, double orgC) => Core.TrimTransform(orgA, orgB, orgC, TrimTolerance);
        ...
        /// <inheritdoc />
        public Fractional3D Transform(double orgA, double orgB, double orgC) => Core.Transform(orgA, orgB, orgC);

        /// <inheritdoc />
        public Fractional3D TrimTransform(in Fractional3D vector) => Core.TrimTransform(vector, TrimTolerance);

        /// <inheritdoc />
        public Fractional3D Transform(in Fractional3D vector) => Core.Transform(vector);

        /// <inheritdoc />
        public Fractional3D TrimTransform(IFractional3D original) => TrimTransform(original.A, original.B, original.C);

        /// <inheritdoc />
        public Fractional3D Transform(IFractional3D original) => Transform(original.A, original.B, original.C);
        ...
        /// <inheritdoc />
        public double[] GetOperationsArray() => Core.ToArray();
