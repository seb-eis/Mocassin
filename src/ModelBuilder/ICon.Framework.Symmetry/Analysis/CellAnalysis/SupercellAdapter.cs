...
namespace Mocassin.Symmetry.Analysis
{
    ...
    public class SuperCellAdapter<T1> : IUnitCellProvider<T1>
    {
        ...
        /// <inheritdoc />
        public LatticePoint<T1> GetCellEntry(int a, int b, int c, int p) => GetCellEntry(new VectorI3(a, b, c), p);
        ...
        /// <inheritdoc />
        public IUnitCell<T1> GetUnitCell(int a, int b, int c) => GetUnitCell(new VectorI3(a, b, c));
        ...
        /// <returns></returns>
        public VectorI3 TrimByPeriodicBoundary(in VectorI3 offset) => TrimByPeriodicBoundary(offset.A, offset.B, offset.C);
        ...
        public Coordinates4I GetSupercellSizeInfo(T1[,,][] entries) =>
            new Coordinates4I(entries.GetLength(0), entries.GetLength(1), entries.GetLength(2),
