...
namespace Mocassin.Tools.Evaluation.Custom.Mmcfe
{
    ...
    public class MmcfeLogCollectionDbContext : SqLiteContext
    {
        ...
        /// <summary>
        ///     Get or set the <see cref="DbSet{TEntity}" /> of <see cref="MmcfeLogMetaEntry" /> that store the log meta
        ///     information
        /// </summary>
        ...
        public void CopyDatabaseWithoutRawData(string filePath)
        {
            ...
            copyContext.LogEntries.AddRange(LogEntries.AsNoTracking().AsEnumerable().Action(x =>
            {
                x.StateBytes = null;
